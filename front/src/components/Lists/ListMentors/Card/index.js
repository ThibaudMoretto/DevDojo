...
const Card = ({ name, image }) => {
  ...
  const roles = ['Dev Front-End', 'Dev Back-End', 'UI/UX Designer', 'Dev mobile', 'Dev wordpress'];
        ...
        <div className="card-mentor-content">
          <div className="card-mentor-info d-flex justify-content-start align-items-center">
            <div className="card-mentor-info-image">
              {
                (image === '')
                  ? <img src="https://edovel.com/wp-content/uploads/2019/06/Quentin.jpg" alt="mentor" />
